...
<div class="container">
    <div class="row justify-content-center">
        ...
        @endif
            ...
            <div class="card">
                <div class="card-header encavezado">
                
                @can('modelos.create')
                    <div style="padding:0px 10px 0px 0px;" class=" d-flex justify-content-end">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                <form id="obs" action="{{ route('modelos.obs',$modelo->id)}}" method="post" enctype='multipart/form-data'>
                                    @csrf
                                    @method('put')

                                    <textarea style="width:100% ;" name="observaciones" id="observaciones" rows="5">{{$modelo->observaciones}}</textarea>
                                    <input id="registrar" type="submit" value="Guardar" class="float-end btn btn-primary">
                                </form>
                            </div>
                ...
                @endcan
                    ...
                    <h3 class="d-flex justify-content-center tex"> <b>{{$modelo->nombre}}</b></h3> 
                    <p class="d-flex justify-content-center tex"><b>{{$id->tipo}}:</b> {{$modelo->nid}}</p>
                    
                    <div class="redes row d-flex justify-content-center" >
                        <div class="col d-flex justify-content-center">
                            <a class="red" id="facebook" target="_blank" href=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                            </svg></a>
                        </div>
                        <div class="col d-flex justify-content-center">
                            <a class="instagram red" id="instagram" target="_blank" href=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        <div class="col d-flex justify-content-center">
                            <a class="tik red" id="tiktok" target="_blank" href=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
                            <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z"/>
                            </svg></a>
                        </div>
                        <div class="col d-flex justify-content-center">
                            <a class="twi red" id="twitter" target="_blank" href=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
