        ...
        <div class="col-md-8">
            <div class="card-transparent">
                <div class="card-header">
                    <h4 style="color:white ;" >Registro turnos de empleados.</h4>
                </div>
            </div>
                ...
                <div class="alert " role="alert">
                    ...
                    <small style="color:#f9d21e ;">Registrar la salida cada vez que finaliza el turno, en caso de olvidar registrar el ingreso abstenerse de registrar la salida.</small>
                </div>
            <div class="card-transparent">
                <div class="card-body">
                    <p style="color:white ;"><b>Ingreso</b></p>
            ...
            <div class="card-transparent">
                <div class="card-body">
                    <p style="color:white ;"><b>Salida</b></p>
                    ...
                    @csrf
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input placeholder=" " autocomplete="off" type="text" style="color:white ;" class="form-control bg-transparent" name="di" id="di" aria-label="Recipient's username" aria-describedby="button-addon2">
                            <input style="color:white ; border-color:white;" type="submit" class="btn btn-outline-secondary" id="button-addon2">
                        </div>
                    </form>
                </div>
